      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <div className="mb-6">
            ...
            <select
              name="service"
              className="w-full bg-[#111111] border-b border-[#2A2A2A] text-[#999999] text-sm py-3 outline-none focus:border-[#C9A84C] transition-colors"
              onChange={handleChange}
              value={form.service}
            >
          ...
          <div className="mb-8">
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-transparent border-b border-[#2A2A2A] text-[#F5F5F5] text-sm py-3 outline-none placeholder:text-[#444] focus:border-[#C9A84C] transition-colors resize-none"
              onChange={handleChange}
              value={form.message}
            />
          </div>
