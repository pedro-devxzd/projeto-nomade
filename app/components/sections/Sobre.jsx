export default function Sobre() {
  const tagStyle = "border border-[#2A2A2A] px-4 py-2 text-[#999999] text-xs uppercase tracking-widest hover:border-[#C9A84C] hover:text-[#C9A84C] transition-colors"
    ...
    <section id="sobre" className="bg-[#0A0A0A] py-32 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center gap-4 mb-20">
          ...
          <p className="text-[#C9A84C] text-xs uppercase tracking-[4px]">Sobre</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div className="relative">
            <div className="bg-[#111111] border border-[#1A1A1A] aspect-square relative overflow-hidden">
            ...
            <div className="absolute -bottom-6 -right-6 bg-[#C9A84C] p-6 hidden md:block">
              ...
              <p className="text-black text-xs font-bold tracking-widest">74548</p>
            </div>
          </div>
          <div>
            ...
            <p className="text-[#999999] text-sm leading-relaxed mb-6">
              Cirurgiã-Dentista com atuação em Clínico Geral e Dentística Estética,
              com experiência em restaurações em resina composta, facetas, clareamento
              dental e reabilitação oral básica.
            </p>
            <p className="text-[#999999] text-sm leading-relaxed mb-10">
              Habilidade em planejamento estético, atendimento humanizado e resolução
              de urgências. Experiência prática em odontologia digital com scanner
              intraoral iTero para planejamento e execução de tratamentos precisos.
            </p>
